    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/products/recommended").permitAll()
                        .requestMatchers(HttpMethod.GET, "/categories/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/brands/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/product-variants/public").permitAll()
                        .requestMatchers(HttpMethod.GET, "/product-images/public").permitAll()
                        .requestMatchers(HttpMethod.GET, "/product-badges/public").permitAll()
